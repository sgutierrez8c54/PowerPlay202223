...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        arm  = hardwareMap.get(DcMotorEx.class,"arm"); //added
        ...
        //added
        MotorConfigurationType motorConfigurationType2 = arm.getMotorType().clone();
        motorConfigurationType2.setAchieveableMaxRPMFraction(1.0);
        arm.setMotorType(motorConfigurationType2);
        ...
        // TODO: reverse any motors using DcMotor.setDirection
            ...
            arm.setDirection(DcMotorSimple.Direction.REVERSE);// added
